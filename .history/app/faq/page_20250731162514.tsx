    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-amber-50">
                    ...
                    <Card key={faqIndex} className="hover:shadow-lg transition-shadow">
                      ...
                      <CardContent>
                        <div className="flex items-start">
                          <Badge variant="outline" className="mr-3 mt-1 text-slate-600 border-slate-600">
                            A
                          </Badge>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">¿No Encuentra su Respuesta?</h2>
          <p className="text-lg text-slate-600 mb-8">
            Nuestro equipo de expertos está disponible para responder cualquier pregunta adicional que pueda tener sobre el mercado inmobiliario dominicano.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: "Chat en Vivo",
                description: "Hable con un agente ahora mismo",
                action: "Iniciar Chat"
              },
              {
                title: "Llámenos",
                description: "Lunes a Viernes 9AM - 6PM",
                action: "+1 (809) 555-0123"
              },
              {
                title: "Email",
                description: "Le responderemos en 24 horas",
                action: "info@meridian-dr.com"
              }
            ].map((item, index) => (
              <Card key={index}>
                <CardHeader>
      ...
      <div className="py-16 bg-amber-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Descubra oportunidades exclusivas en el mercado inmobiliario dominicano con la asesoría de nuestros expertos.
          </p>
